    ...
    async fetchCarouselItems() {
      try {
        ...
        const queryParams = new URLSearchParams({
          ...
          platform: this.selectedFilters['Platform'] || '',
          developer: this.selectedFilters['Developer'] || '',
          publisher: this.selectedFilters['Publisher'] || '',
          playtime: this.selectedFilters['Playtime'] || '',
          metacritic: this.selectedFilters['Metacritic'] || '',
          esrb: this.selectedFilters['ESRB'] || '',
          tba: this.selectedFilters['TBA'] || '',
          rating: this.selectedFilters['Rating'] || '',
          year: this.selectedFilters['Year'] || '',
        }).toString();

        const response = await fetch(`http://localhost:8080/games/elastic/searchWithFilters?${queryParams}`, {
          method: 'GET',
          headers: {
